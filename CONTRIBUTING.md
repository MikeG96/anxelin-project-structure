# Contributing to anxelin-project-structure

First and foremost, thank you! We appreciate that you want to contribute to anxelin-project-structure, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for anxelin-project-structure**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for anxelin-project-structure:

- star the [project](https://github.com/MikeG96/anxelin-project-structure/#README)
- tweet your support for anxelin-project-structure
...
- **version**: (required) please note the version of anxelin-project-structure are you using
...
The original poster or the maintainers of anxelin-project-structure may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/anxelin-project-structure
